...
public class UserUpdation {
	...
	public static WebDriver driver;
                ...
                public static void UserUpdation() throws IOException, InterruptedException {
                  ...
                  //WebDriver driver = new FirefoxDriver();
                    ...
                    {           
                              ...
                              turretid.setCellType(turretid.CELL_TYPE_STRING);*/
                                   ...
                                   //Create User
                              User_Updation_testdata(user.getStringCellValue().trim()); 
                              Add_keyPageset_to_user("xyz", user.getStringCellValue().trim(), "551181");
                ...
                public static void Add_keyPageset_to_user(String keyPageset_name, String user_name, String vla_num) throws InterruptedException{
                 ...
                 /*   enter_data_in_textbox("//*[@id='userConfigForm:userConfigTabView:0:userProfileNameText']",user_name);
                    ...
                    if (search_text.equals(user_name)){
                    	...
                    	Thread.sleep(2000);
                    	enter_data_in_textbox("//*[@id='userConfigForm:userConfigTabView:1:settingsTabView:defaultDDIMenu_input']","551181");
                    	Thread.sleep(2000);
                    	button_click("//*[@id='userConfigForm:saveBtn']/span");
                    	Thread.sleep(5000);
                    	break;
 ...
 public static void User_Updation_testdata(String user) throws InterruptedException{
                    ...
                    enter_data_in_textbox("//*[@id='userForm:userInfoTable:userHeader:filter']",user);
                    enter_data_in_textbox("//*[@id='userForm:userInfoTable:firstNameHeader:filter']","");
                  ...
                  //  Thread.sleep(2000);
                    for(int j=0;j<=20;j++){
                    search_text=get_text_of_element("//*[@id='userForm:userInfoTable:"+j+":useridlink']");
                    System.out.println(search_text);
                    if (search_text.equals(user)){
                    	
                    	select_unselect_checkbox_radio("//*[@id='userForm:userInfoTable:"+j+":useridlink']");
                    	//for(i=0;i<3;i++){
                    	Thread.sleep(5000);
                  	  driver.findElement(By.xpath("//*[@id='userForm:pin']")).clear();
                  	driver.findElement(By.xpath("//*[@id='userForm:reenter_pin']")).clear();
                  	driver.findElement(By.xpath("//*[@id='userForm:hitouchpassword']")).clear();
                  	driver.findElement(By.xpath("//*[@id='userForm:reenter_hitouchpwd']")).clear();
